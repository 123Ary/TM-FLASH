...
public class Home extends AppCompatActivity implements SearchView.OnQueryTextListener, View.OnClickListener {
    int flag=0;
                                    ...
                                    new Thread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if(uploadStatus==200)
                                            {
                                                runOnUiThread(new Runnable() {
                                                    public void run() {
                                                        AlertDialog dialog = new AlertDialog.Builder(Home.this).setTitle("Finished" )
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.buttonecu) {
            startActivity(new Intent(Home.this, ECU_Flash.class));
        }
